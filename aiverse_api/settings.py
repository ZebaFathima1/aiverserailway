"""
Production settings for aiverse_api project.
"""
...
# Add Railway and Render default domains
...
# CORS settings - Get frontend URL from environment
...
if CORS_EXTRA_ORIGINS:
    CORS_ALLOWED_ORIGINS.extend(CORS_EXTRA_ORIGINS.split(','))
...
if not DEBUG:
    ...
    if CORS_EXTRA_ORIGINS:
        CSRF_TRUSTED_ORIGINS.extend(CORS_EXTRA_ORIGINS.split(','))
